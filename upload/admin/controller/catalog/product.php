...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
                ...
                $filter_data = $this->filter->getFilters();
                $filter_data['start'] = (int)$filter_data['page'];  //todo check for safe
		...
		$data['sort_order'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=p.sort_order' . $url, 'SSL');
                ...
                $p_url= $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');

		$pagination = new Pagination($product_total,$filter_data['page'],$filter_data['limit'],$p_url);
		...
		$this->response->setOutput($this->load->view('catalog/product_list.tpl', $data, $language));
	}
